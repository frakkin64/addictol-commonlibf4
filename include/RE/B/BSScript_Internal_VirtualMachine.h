...
namespace RE
{
	namespace BSScript
	{
		...
		namespace Internal
		{
			...
			private:
				void ForEachBoundObjectRaw(std::uint64_t a_objHandle, const void* a_functor) override; // 1E
			...
			private:
				void SendEventRaw(std::uint64_t a_objHandle, const BSFixedString& a_eventName, const void* a_arguments, const void* a_filter, const BSTSmartPointer<IStackCallbackFunctor>& a_callback) override; // 2B
				bool DispatchStaticCallRaw(const BSFixedString& a_objName, const BSFixedString& a_funcName, const void* a_arguments, const BSTSmartPointer<IStackCallbackFunctor>& a_callback) override; // 2C
				bool DispatchMethodCallRaw(std::uint64_t a_objHandle, const BSFixedString& a_objName, const BSFixedString& a_funcName, const void* a_arguments, const BSTSmartPointer<IStackCallbackFunctor>& a_callback) override; // 2E
				bool DispatchMethodCallRaw(const BSTSmartPointer<Object>& a_self, const BSFixedString& a_funcName, const void* a_arguments, const BSTSmartPointer<IStackCallbackFunctor>& a_callback) override; // 2D
				bool DispatchUnboundMethodCallRaw(std::uint64_t a_objHandle, const BSTSmartPointer<BoundScript>& a_script, const BSFixedString& a_funcName, const void* a_arguments, const BSTSmartPointer<IStackCallbackFunctor>& a_callback) override; // 2F
